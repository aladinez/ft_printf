...
/*   Updated: 2019/11/19 15:23:36 by aez-zaou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	fprintf(file, "unsigned %u signed %i\n", num, nam);
	ft_printf("unsigned %u signed %i\n",num, nam);
...
//	ft_printf("test with flags [0] %02147483648d with unsigned int %04294967296u\n", nam, num);
	...
	//t_printf("test with flags [-] hexadecimal %02147483648xxx\n", num);
